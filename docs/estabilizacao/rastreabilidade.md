...
| EST-FE-002 | P15 | 09 | Bloqueador | Build frontend falha por `data` possivelmente indefinido em `KanbanBoard` | #27 | fix/EST-FE-002-kanban-data-narrowing | - | Corrigido localmente |
