...
| EST-DEV-001 | DX | Geral | Alto | `start.ps1` imprime erros `PID : O termo 'PID' nao e reconhecido` ao iniciar Celery/Vite | #30 | fix/EST-DEV-001-start-pid-output | #31 | Em PR |
