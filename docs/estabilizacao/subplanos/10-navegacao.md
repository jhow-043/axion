...
| EST-FE-004 | Medio | React Router emite warning `No HydrateFallback element provided` no console do navegador | `frontend/src/app/router.tsx` | Abrir `http://localhost:5173` com Vite em dev |
| — | — | *A preencher* | — | — |
