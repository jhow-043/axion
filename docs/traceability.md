...
| RF/RNF | Descrição resumida | Spec | ADR | Branch/PR | Status |
|--------|-------------------|------|-----|-----------|--------|
| RF-080 | Chamado industrial exige equipamento | P09 | ADR-0003 | feature/009 | pending |
| RF-081 | Chamado predial exige local | P09 | ADR-0003 | feature/009 | pending |
| RF-082 | Status inicial `new` | P09 | ADR-0003 | feature/009 | pending |
| RF-083 | Assumir = responsável + `in_progress` | P09 | ADR-0003 | feature/009 | pending |
| RF-084 | Pendente exige motivo | P09 | ADR-0003 | feature/009 | pending |
| RF-085 | Resolvido exige solução | P09 | ADR-0003 | feature/009 | pending |
| RF-086 | Fechado é terminal | P09 | ADR-0003 | feature/009 | pending |
| RF-087–092 | Observadores, comentários, visibilidade, filtros | P09 | ADR-0002 | feature/009 | pending |

## SLA

| RF/RNF | Descrição resumida | Spec | ADR | Branch/PR | Status |
|--------|-------------------|------|-----|-----------|--------|
| RF-120 | Política configurável | P12 | ADR-0001 | feature/012 | pending |
| RF-121 | SLA de Atendimento | P12 | ADR-0004 | feature/012 | pending |
| RF-122 | SLA de Resolução | P12 | ADR-0004 | feature/012 | pending |
| RF-123 | SLA pausado em `pending` | P12 | ADR-0003 | feature/012 | pending |
| RF-124 | Prazo recalculado após pausa | P12 | — | feature/012 | pending |
| RF-125–126 | Alertas e vencimento automáticos | P12 | ADR-0004 | feature/012 | pending |
| RF-127 | Indicador de SLA na tela | P12 | — | feature/012 | pending |

## Notificações e Encerramento

| RF/RNF | Descrição resumida | Spec | ADR | Branch/PR | Status |
|--------|-------------------|------|-----|-----------|--------|
| RF-130–132 | Validação e auto-fechamento | P13 | ADR-0003, ADR-0004 | feature/013 | pending |
| RF-140–145 | Notificações in-app, WebSocket, e-mail | P14 | ADR-0004 | feature/014 | pending |

## Dashboards, Auditoria e Admin

| RF/RNF | Descrição resumida | Spec | ADR | Branch/PR | Status |
|--------|-------------------|------|-----|-----------|--------|
| RF-150–151 | Dashboards operacionais | P15 | ADR-0001 | feature/015 | pending |
| RF-160–161 | Dashboard gerencial e relatórios | P16 | ADR-0001 | feature/016 | pending |
| RF-170–171 | Auditoria imutável | P17 | ADR-0001 | feature/017 | pending |
| RF-180–182 | Console de administração | P18 | ADR-0001 | feature/018 | pending |
